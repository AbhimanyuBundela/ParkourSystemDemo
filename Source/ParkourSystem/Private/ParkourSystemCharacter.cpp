...
AParkourSystemCharacter::AParkourSystemCharacter(const FObjectInitializer& ObjectInitializer)
...
{
	PS_CharacterMovementComponent = Cast<UPS_CharacterMovementComponent>(GetCharacterMovement());
